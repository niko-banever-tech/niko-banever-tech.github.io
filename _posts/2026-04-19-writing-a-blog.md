...
for this blog, I will be using jekyll hosted on github pages, which is completely free!
...
Github pages is a service offered by github, that allows you to host your own static website on github for free!
...
For example, to create my github pages I created a new repository named
> glacier-cybertech.github.io

this will be the same url as the website it creates!

![Screenshot of my Blog Repo](https://raw.githubusercontent.com/glacier-cybertech/glacier-cybertech.github.io/refs/heads/main/images/Screenshot%202026-04-19%20144328.png)

<h2 style="color:hotpink;"> Configuring the blog </h2>
now that the blog is created, it should appear at (your-username).github.io !
...
i also went into the index.md file, which will be the main page for my blog site, and copied over the readme.md file i made for my github profile  
